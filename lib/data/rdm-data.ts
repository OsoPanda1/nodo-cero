...
export const RDM_POIS: POI[] = [
  {
    ...
    history: 'Inició operaciones en la época virreinal y fue clave durante la llegada de los mineros de Cornualles (Reino Unido) en 1824.',
    phygitalBadge: 'Insignia Guardián Minero',
    rating: 4.9,
    image: 'https://picsum.photos/seed/mina-acosta/800/600',
    status: 'Tour Guiado',
  ...
  },
  {
    ...
    lat: 20.1458,
    lng: -98.6748,
    description: 'Cementerio único rodeado de oyameles donde descansan los mineros británicos de Cornualles. Todas las tumbas apuntan hacia Inglaterra.',
    history: 'Fundado en 1828. Mantiene la historia de Inés Valiño y el famoso zapatero John Vial.',
    phygitalBadge: 'Sello Cornish Heritage',
    rating: 4.95,
    image: 'https://picsum.photos/seed/panteon-ingles/800/600',
    status: 'Abierto',
  ...
  },
  {
    ...
    history: 'Símbolo del esplendor tecnológico de finales del siglo XIX.',
    phygitalBadge: 'Sello Vapor y Electricidad',
    rating: 4.8,
    image: 'https://picsum.photos/seed/mina-dificultad/800/600',
    status: 'Abierto',
  ...
  },
  {
    ...
    history: 'El paste fue traído por los mineros de Cornualles en 1824. Su trenzado lateral permitía a los mineros comerlo con las manos sucias de tierra sin contaminar la comida.',
    phygitalBadge: 'Maestro del Trenzado Cornish',
    rating: 4.98,
    image: 'https://picsum.photos/seed/pastes-portal/800/600',
    status: 'Abierto',
  ...
  },
  {
    ...
    history: 'Construida en el siglo XVIII financiada por las bonanzas del Conde de Regla.',
    phygitalBadge: 'Sello Corazón del Monte',
    rating: 4.85,
    image: 'https://picsum.photos/seed/parroquia-rosario/800/600',
    status: 'Abierto',
  ...
  },
  {
    ...
    history: 'Mítico paraje natural guardián de los manantiales del altiplano.',
    phygitalBadge: 'Explorador del Bosque Esmeralda',
    rating: 4.9,
    image: 'https://picsum.photos/seed/penas-cargadas/800/600',
    status: 'Abierto',
  ...
  },
  {
    ...
    rating: 4.92,
    image: 'https://picsum.photos/seed/plateria-real/800/600',
    status: 'Abierto',
